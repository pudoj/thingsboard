...
export default function addLocaleChinese(locales) {
    var zh_CN = {
        ...
        "dashboard" : {
            ...
            "dashboards" : "组态库",
            "management" : "组态库管理",
            "view-dashboards" : "查看组态库",
            "add" : "添加组态库",
            "assign-dashboard-to-customer" : "将组态库分配给客户",
            "assign-dashboard-to-customer-text" : "请选择要分配给客户的组态库",
            "assign-to-customer-text" : "请选择客户分配组态库",
            "assign-to-customer" : "分配给客户",
            "unassign-from-customer" : "取消分配客户",
            "make-public" : "使组态库公有",
            "make-private" : "使组态库私有",
            "no-dashboards-text" : "没有找到组态库",
            "no-widgets" : "没有配置部件",
            "add-widget" : "添加新的部件",
            "title" : "标题",
            ...
            "description" : "描述",
            "details" : "详情",
            "dashboard-details" : "组态库详情",
            "add-dashboard-text" : "添加新的组态库",
            "assign-dashboards" : "分配组态库",
            "assign-new-dashboard" : "分配新的组态库",
            "assign-dashboards-text" : "分配 { count, select, 1 {1 dashboard} other {# dashboards} } 给客户",
            "delete-dashboards" : "删除组态库",
            "unassign-dashboards" : "取消分配组态库",
            "unassign-dashboards-action-title" : "取消分配 { count, select, 1 {1 dashboard} other {# dashboards} } from customer",
            "delete-dashboard-title" : "您确定要删除组态库 '{{dashboardTitle}}'吗？",
            "delete-dashboard-text" : "小心！确认后组态库及其所有相关数据将不可恢复。",
            ...
            "delete-dashboards-text" : "小心！确认后所有选定的组态库将被删除，所有相关数据将不可恢复。",
            "unassign-dashboard-title" : "您确定要取消分配组态库 '{{dashboardTitle}}'吗？",
            "unassign-dashboard-text" : "确认后，面板将被取消分配，客户将无法访问。",
            "unassign-dashboard" : "取消分配组态库",
            "unassign-dashboards-title" : "您确定要取消分配组态库 { count, select, 1 {1 dashboard} other {# dashboards} } 吗？",
            "unassign-dashboards-text" : "确认后，所有选定的组态库将被取消分配，客户将无法访问。",
            "public-dashboard-title" : "组态库现已公布",
            "public-dashboard-text" : "你的组态库 <b>{{dashboardTitle}}</b> 已被公开，可通过如下 <a href='{{publicLink}}' target='_blank'>链接</a>访问:",
            "public-dashboard-notice" : "<b>提示：</b> 不要忘记将相关设备公开以访问其数据。",
            "make-private-dashboard-title" : "您确定要使组态库 '{{dashboardTitle}}' 私有吗？",
            "make-private-dashboard-text" : "确认后，组态库将被私有，不能被其他人访问。",
            "make-private-dashboard" : "组态库私有",
            "socialshare-text" : "'{{dashboardTitle}}' 由ThingsBoard提供支持",
            "socialshare-title" : "'{{dashboardTitle}}' 由ThingsBoard提供支持",
            "select-dashboard" : "选择组态库",
            "no-dashboards-matching" : "找不到符合 '{{entity}}' 的组态库。",
            "dashboard-required" : "组态库是必需的。",
            "select-existing" : "选择现有组态库",
            "create-new" : "创建新的组态库",
            "new-dashboard-title" : "新组态库标题",
            "open-dashboard" : "打开组态库",
            "set-background" : "设置背景",
            ...
            "import" : "导入组态库",
            "export" : "导出组态库",
            "export-failed-error" : "无法导出组态库: {{error}}",
            "create-new-dashboard" : "创建新的组态库",
            "dashboard-file" : "组态库文件",
            "invalid-dashboard-file-error" : "无法导入组态库: 组态库数据结构无效。",
            "dashboard-import-missing-aliases-title" : "配置导入组态库使用的别名",
            "create-new-widget" : "创建新部件",
            "import-widget" : "导入部件",
            "widget-file" : "部件文件",
            "invalid-widget-file-error" : "无法导入窗口部件: 窗口部件数据结构无效。",
            "widget-import-missing-aliases-title" : "配置导入的窗口部件使用的别名",
            "open-toolbar" : "打开组态库工具栏",
            "close-toolbar" : "关闭工具栏",
            "configuration-error" : "配置错误",
            "alias-resolution-error-title" : "组态库别名配置错误",
            ...
            "public-link-copied-message" : "组态库的公共链接已被复制到剪贴板"
        },
        "datakey" : {
            "settings": "设置",
            "advanced": "高级",
        ...
        "widget" : {
            ...
            "remove-widget-text" : "确认后，部件及其所有相关数据将不可恢复。",
            "timeseries" : "时间序列",
            "latest-values" : "最新值",
            "rpc" : "控件部件",
            "static" : "静态部件",
            ...
            "save-widget-type-as-text" : "请输入新的部件标题和/或选择目标部件",
            ...
            "remove-widget-type-text" : "确认后，部件类型及其所有相关数据将不可恢复。",
        ...
        "widgets-bundle" : {
            ...
            "delete-widgets-bundle-text" : "小心！确认后，部件包及其所有相关数据将不可恢复。",
        ...
        "widget-config" : {
            ...
            "decimals" : "浮点数后的位数",
            "timewindow" : "时间窗口",
            "use-dashboard-timewindow" : "使用组态库的时间窗口",
            "display-legend" : "显示图例",
            "datasources" : "数据源",
            "datasource-type" : "类型",
